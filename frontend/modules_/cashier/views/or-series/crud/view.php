...
$this->title = 'OneLab';
$context = 'Official Receipt Category: ';
$this->params['breadcrumbs'][] = ['label' => 'Official Receipt Series', 'url' => ['index']];
$this->params['breadcrumbs'][] = 'View';
\yii\web\YiiAsset::register($this);
?>
<div class="or-series-view" style="background-color: white;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 context">
                Manage <?= \yii\helpers\Inflector::camel2words(\yii\helpers\Inflector::id2camel($context)).'&nbsp;'.$model->category->category; ?>
            </div>
        </div>
        <div class="row">
