...
/**
 * Service represents the model behind the search form of `frontend\modules\models\accounting\Service`.
 */
class Service extends ServiceModel
{
    ...
    public function rules()
    {
        return [
            [['id', 'fund_id'], 'integer'],
            [['service_code', 'uacs', 'subject_code', 'uacs_desc', 'service_title'], 'safe'],
        ];
    }
