...
<div class="order-of-payment-request" style="background-color: white;">
    <div class="container-fluid">
        ...
        <form method="post" action="details">
            ...
            <!--<input type="hidden" name="custName" id="custName" value="?= $customer->customerName; ?>" >-->
            <div class="row">
                <div class="col-lg-12">
                    <?php Pjax::begin(); ?>
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                [
                                    'header' => 'Item',
                                    'headerOptions' => ['style' => 'width: 7%; color: #3c8dbc;'],
                                ...
                                [
                                    'attribute' => 'requestRefNum',
                                    'header' => 'Request Reference Number',
                                    'headerOptions' => ['style' => 'width: 33%; color: #3c8dbc;'],
                                    'value' => 'requestRefNum',
                                ],
                                [
                                    'attribute' => 'requestDate',
                                    'header' => 'Request Date',
                                    'headerOptions' => ['style' => 'width: 20%; color: #3c8dbc;'],
                                    'value' => 'requestDate',
                                ],
                                [
                                    'attribute' => 'total',
