...
class OrderOfPaymentController extends Controller
{
    ...
    public function actionDetails()
    {
        if(isset($_POST['custId']) && isset($_POST['div_code']) && isset($_POST['type_code']) && isset($_POST['requestId'])){
            $render = $_POST['type_code'].'-details';
            ...
            try{
                if($_POST['payment_type'] == 2){
                    ...
                    if($epaymentResult){
                        ...
                        /*$modelOop->transaction_num = '2020-02-0001';
                        $modelOop->customer_id = $_POST['custId'];
                        $modelOop->total_amount = $_POST['total'];
                        $modelOop->total_balance = $_POST['totalBalance'];
                        $modelOop->status_id = 3;
                        $modelOop->date_op = date('Y-m-d');

                        $result = $modelOop->save();*/
                        ...
                        if($oopResult){
                            ...
                            foreach($id as $key=>$value){
                                ...
                                $oopDetailsResult = $connection->createCommand()->insert('oop_details', [
                                    'op_id' => $opId,
                                    'request_id' => $value,
                                    /*'fund_id' => $_POST['fund'][$key],
                                    'service_id' => $_POST['service'],*/
                                    //'collection_type_id' => $_POST['incomeCode'][$key],
                                    //'division_id' => 1,
