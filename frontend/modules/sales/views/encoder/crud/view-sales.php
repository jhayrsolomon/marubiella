            ...
            <div class="col-sm-12">
                ...
                <!--<table id="in_out_record" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">-->
                    <thead>
                        ...
                        <tr class="bg-primary">
                            <th colspan="10">Validated Sales</th>
                        </tr>
                        <!--<tr>
                            <th colspan="3">
                    ...
                    <tbody class="text-center">
                        <?php
                            $totalqty = 0;
                            $totalprice = 0;
                            if(count($salesValidated) == 0){
                                echo "<tr><td colspan='8'>No Record(s)</td></tr>";
                            } else {
                                foreach($salesValidated as $key=>$value){
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <!--<table id="in_out_record" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">-->
                    <thead>
                        <tr class="bg-primary">
                            <th colspan="10">Unvalidated Sales</th>
                        </tr>
                        <!--<tr class="bg-info">
                            <th colspan="10">
                                ?php
