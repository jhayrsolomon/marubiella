                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="productRow">
                        <tr>
                            ...
                            <td>
                                <?= $form->field($model, 'product_id')->dropDownList($product, ['prompt'=>'Select Product', 'name'=>'product_id[]', 'id' => 'product_id0', 'class' => 'form-control form-control-sm', 'onchange' => 'getDetails(0);'])->label(''); ?>
                            </td>
                            <td>
                                <?= $form->field($model, 'quantity')->textInput(['maxlength' => true, 'placeholder' => 'Quantity', 'type' => 'number', 'name' => 'quantity[]', 'id' => 'quantity0', 'class' => 'form-control form-control-sm', 'onchange' => 'getQuantity(0);'])->label('') ?>
                            </td>
                            <td>
                                <?= $form->field($model, 'collectible_amount')->textInput(['maxlength' => true, 'placeholder' => '0.00', 'type' => 'number', 'name' => 'collectible_amount[]', 'id' => 'collectible_amount0', 'readonly' => true, 'class' => 'form-control form-control-sm'])->label('') ?>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>
