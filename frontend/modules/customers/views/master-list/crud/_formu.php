        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm 12" id="address">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <?= $form->field($model, 'province_id')->dropDownList($province, ['prompt'=>'Select Province'])->label('Province'); ?>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <?= $form->field($model, 'municipality_id')->dropDownList($municipality, ['prompt'=>'Select Municipality'])->label('Municipality'); ?>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <?= $form->field($model, 'barangay_id')->dropDownList($barangay, ['prompt'=>'Select Barangay'])->label('Barangay'); ?>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-12 col-sm-12">
