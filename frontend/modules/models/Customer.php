...
class Customer extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['customer_code', 'customer_firstname', 'customer_lastname', 'gender', 'age', 'customer_type_id', 'prefix_address', 'barangay_id', 'municipality_id', 'province_id', 'region_id', 'landmark', 'customer_status_id'], 'required'],
