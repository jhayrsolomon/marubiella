...
class SalesOnline extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sales_code', 'employee_id', 'team_id', 'customer_id', 'customer_type_id', 'total_amount', 'care_of', 'sales_status_id', 'page'], 'required'],
    ...
    {
        return $this->hasMany(SalesProduct::className(), ['sales_online_id' => 'id']);
    }*/
}
