...
class SalesOnlineSearch extends SalesOnline
{
    ...
    public function rules()
    {
        return [
            ...
            [['sales_code', 'sales_tracking_number', 'product_id', 'quantity', 'collectible_amount', 'care_of', 'osr_remark', 'page', 'csr_remark', 'dispatcher_remark', 'date_created', 'date_updated', 'date_deleted'], 'safe'],
            [['total_amount'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'sales_code', $this->sales_code])
            ...
            ->andFilterWhere(['like', 'collectible_amount', $this->collectible_amount])
