...
CREATE TABLE `employee` (
  ...
  `employee_affiliation_id` int(11) NOT NULL,
...
INSERT INTO `employee` (`id`, `user_id`, `user_code`, `employee_address_id`, `employee_affiliation_id`, `firstname`, `middlename`, `lastname`, `cellphone_number`, `telephone_number`, `date_of_birth`, `is_active`, `status_id`, `date_created`, `date_updated`, `date_deleted`) VALUES
(1, 1, 'gZdqBAyyV3t7WAIpzHnDhQbDyWsWD0aK', 1, 1, 'john raymund', 'abenojar', 'solomon', '09264372840', 'N/A', '1993-05-18', 1, 1, '2021-02-10 18:59:56', '2021-02-12 23:56:17', NULL),
(2, 2, 'O0eOJ3b-5QBGP8jzHIY1p_uy4zalrjwG', 2, 2, 'Raymund', 'Solomon', 'Abenojar', '09511631473', 'N/A', '1990-03-18', 1, 1, '2021-02-11 22:14:45', '2021-02-12 23:57:03', NULL),
(3, 11, 'YSyCRM5WBX2jHrSg6zDxw5tMnLlVKMu6', 3, 3, 'john floyd', 'terrado', 'ferrer', '09090602900', 'na', '2000-09-18', 1, 1, '2021-02-12 18:17:44', '2021-02-12 23:57:07', NULL),
(4, NULL, NULL, 4, 4, 'Alexander Kim', 'Carreon', 'Gemino', '09302182773', 'N/A', '2001-12-29', 1, 1, '2021-02-12 18:19:36', '2021-02-12 23:57:09', NULL);
